...
class SkillOutputInline(BaseModel):
    ...
    allowedTools: list[str] | None = Field(default=None, description="Tools allowed by this skill")
    model: str | None = Field(default=None, description="Model to use for this skill")
    prompt: str | None = Field(default=None, description="Resolved skill prompt content")
    description: str | None = Field(default=None, description="Short description of the skill")
    sourcePath: str | None = Field(default=None, description="Where the skill was loaded from")
    status: str | None = Field(default="inline", description="Execution status")
# 在独立子agent使用
